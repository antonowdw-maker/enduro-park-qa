...
Рекомендуемый старт: **E → F…** (A–D закрыты; ревью A–D + hotfix `fix/tl-review-waves-a-d`).
...
*Последнее обновление: 15.07.2026 — синхрон docs перед E; зафиксирован формат коммитов **вариант B** (`type(scope):`).*
