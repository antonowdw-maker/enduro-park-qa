...
**Версия:** 1.5  
**Дата:** 13.07.2026  
**Изменения от v1.4:** валидация диапазонов, кнопки очистки фильтров, запрет отрицательных значений.

**История:** v1.4 — offset, фильтры год/пробег; v1.3 — негативная валидация, BUG-03, дата ТО; v1.2 — публичная главная, без guest, VIN edit; v1.1 — исходный PDF.
