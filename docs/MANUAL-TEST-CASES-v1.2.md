...
**Версия:** 1.6  
**Дата:** 13.07.2026  
**Изменения от v1.5:** итерация 9 — детерминированный seed; бэклог — TC-FILTER-MULTI-*, TC-BIKE-LAST-* (текст + календарь + маска).
...
🤖 **Автотест:** `e2e/tests/validation.spec.ts` (итерация 10.5; корректная граница — зелёный).
