...
**Версия:** 1.3  
**Дата:** 13.07.2026  
**Изменения от v1.2:** итерация 7 — негативная валидация, BUG-03, дата ТО (границы 1990 / не в будущем / реальная дата).

**История:** v1.2 — публичная главная, без guest, VIN edit; v1.1 — исходный PDF.
