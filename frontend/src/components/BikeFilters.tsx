...
import { MAX_YEAR_FILTER_DIGITS } from '../utils/filterValidation';
...
export default function BikeFilters({
  ...
  // Держим advanced открытым, пока в нём есть значения/ошибки (без setState в effect)
  const showAdvanced = advancedOpen || hasAdvancedValues;
